 ...
 *
 * Port of the Python example's `frontend/src/App.tsx` provider/bootstrap
 * layer; presentation lives under `./components/`.
 */
...
/**
 * LangGraph SDK base URL for this dev setup.
 *
 * Browser calls use `/api/threads/…`; Vite strips the `/api` prefix and
 * forwards to the protocol server routes at `/threads/…`.
 */
